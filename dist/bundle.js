...
Object.defineProperty(exports, "__esModule", { value: true });
var collidable_1 = __webpack_require__(4);
var game_1 = __webpack_require__(0);
var levelConstants_1 = __webpack_require__(2);
var deathParticle_1 = __webpack_require__(28);
...
Object.defineProperty(exports, "__esModule", { value: true });
var wall_1 = __webpack_require__(26);
var levelConstants_1 = __webpack_require__(2);
var floor_1 = __webpack_require__(5);
var game_1 = __webpack_require__(0);
var collidable_1 = __webpack_require__(4);
var knightEnemy_1 = __webpack_require__(27);
var chest_1 = __webpack_require__(17);
var goldenKey_1 = __webpack_require__(32);
var spike_1 = __webpack_require__(19);
var gameConstants_1 = __webpack_require__(1);
var wizardEnemy_1 = __webpack_require__(33);
var skullEnemy_1 = __webpack_require__(36);
var pyroEnemy_1 = __webpack_require__(37);
var barrel_1 = __webpack_require__(22);
var crate_1 = __webpack_require__(23);
var arch_1 = __webpack_require__(39);
var sideArch_1 = __webpack_require__(40);
var camera_1 = __webpack_require__(13);
var bones_1 = __webpack_require__(41);
var door_1 = __webpack_require__(6);
var sideDoor_1 = __webpack_require__(42);
var layeredTile_1 = __webpack_require__(15);
var collidableLayeredTile_1 = __webpack_require__(14);
var stairUp_1 = __webpack_require__(43);
var stairDown_1 = __webpack_require__(44);
var onCollideLayeredTile_1 = __webpack_require__(24);
var TurnState;
(function (TurnState) {
...
var Level = (function () {
    function Level(game, levelData, env) {
        ...
        this.exitLevel = function () {
            ...
            _this.playerExitX = _this.game.player.x;
            _this.playerExitY = _this.game.player.y;
        };
        ...
        this.enterLevel = function () {
            ...
            _this.game.player.moveNoSmooth(_this.playerExitX, _this.playerExitY);
            _this.updateLighting();
            camera_1.Camera.snap(_this.game.player.x - levelConstants_1.LevelConstants.SCREEN_W * 0.5 + 0.5, _this.game.player.y - levelConstants_1.LevelConstants.SCREEN_H * 0.5 + 0.5);
        };
            ...
            for (var x = 0; x < _this.levelArray.length; x++) {
                for (var y = 0; y < _this.levelArray[0].length; y++) {
                    if (_this.levelArray[x][y] !== null) {
                        ...
                        else if (_this.levelArray[x][y] instanceof onCollideLayeredTile_1.OnCollideLayeredTile) {
                            _this.levelArray[x][y].drawCeiling();
                        }
                        else {
                            continue;
                ...
                if (tileSourceSet !== null) {
                    ...
                    switch (tilegid - tileSourceSet.firstgid) {
                        ...
                        case 11:
                            ...
                            break;
                        case 14:
                            this.levelArray[x][y] = new stairUp_1.StairUp(this, x, y);
                            break;
                        case 15:
                            this.levelArray[x][y] = new stairDown_1.StairDown(this, x, y);
                            break;
                        case 16:
...
Object.defineProperty(exports, "__esModule", { value: true });
var game_1 = __webpack_require__(0);
var key_1 = __webpack_require__(29);
var heart_1 = __webpack_require__(30);
var armor_1 = __webpack_require__(31);
...
Object.defineProperty(exports, "__esModule", { value: true });
var game_1 = __webpack_require__(0);
var onCollideTile_1 = __webpack_require__(20);
...
Object.defineProperty(exports, "__esModule", { value: true });
var collidable_1 = __webpack_require__(4);
var OnCollideTile = (function (_super) {
    __extends(OnCollideTile, _super);
    function OnCollideTile() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.onCollide = function (player) { };
        return _this;
    }
    return OnCollideTile;
}(collidable_1.Collidable));
exports.OnCollideTile = OnCollideTile;
...
Object.defineProperty(exports, "__esModule", { value: true });
var onCollideTile_1 = __webpack_require__(20);
var OnCollideLayeredTile = (function (_super) {
    __extends(OnCollideLayeredTile, _super);
    function OnCollideLayeredTile() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.onCollide = function (player) { };
        _this.drawCeiling = function () { };
        return _this;
    }
    return OnCollideLayeredTile;
}(onCollideTile_1.OnCollideTile));
exports.OnCollideLayeredTile = OnCollideLayeredTile;
...
var enemy_1 = __webpack_require__(3);
var game_1 = __webpack_require__(0);
var pyroFireball_1 = __webpack_require__(38);
var PyroState;
(function (PyroState) {
...
var level_1 = __webpack_require__(9);
var onCollideLayeredTile_1 = __webpack_require__(24);
var StairUp = (function (_super) {
    __extends(StairUp, _super);
    function StairUp() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.onCollide = function (player) {
            if (!_this.linkedLevel) {
                _this.linkedLevel = new level_1.Level(_this.level.game, _this.level.game.levelData, 0);
                _this.linkedLevel.playerExitX = 16;
                _this.linkedLevel.playerExitY = 11;
                _this.linkedLevel.levelArray[16][11].linkedLevel = _this.level;
            }
            player.game.changeLevel(_this.linkedLevel);
        };
        _this.draw = function () {
            game_1.Game.drawTile(14, 0, 1, 1, _this.x, _this.y, 1, 1);
            if (_this.level.game.player.y >= _this.y)
                game_1.Game.drawTile(15, 0, 1, 1, _this.x, _this.y - 1, 1, 1);
        };
        _this.drawCeiling = function () {
            if (_this.level.game.player.y < _this.y)
                game_1.Game.drawTile(15, 0, 1, 1, _this.x, _this.y - 1, 1, 1);
    ...
    return StairUp;
}(onCollideLayeredTile_1.OnCollideLayeredTile));
exports.StairUp = StairUp;
...
var level_1 = __webpack_require__(9);
var onCollideLayeredTile_1 = __webpack_require__(24);
var StairDown = (function (_super) {
    __extends(StairDown, _super);
    function StairDown() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.onCollide = function (player) {
            if (!_this.linkedLevel) {
                _this.linkedLevel = new level_1.Level(_this.level.game, _this.level.game.levelData, 0);
                _this.linkedLevel.playerExitX = 21;
                _this.linkedLevel.playerExitY = 10;
                _this.linkedLevel.levelArray[21][10].linkedLevel = _this.level;
            }
            player.game.changeLevel(_this.linkedLevel);
        };
        _this.draw = function () {
            game_1.Game.drawTile(2, 1, 1, 1, _this.x, _this.y, 1, 1);
            game_1.Game.drawTile(15, 0, 1, 1, _this.x, _this.y, 1, 1);
        };
        return _this;
    }
    return StairDown;
}(onCollideLayeredTile_1.OnCollideLayeredTile));
exports.StairDown = StairDown;
...
var gameConstants_1 = __webpack_require__(1);
var game_1 = __webpack_require__(0);
var inventory_1 = __webpack_require__(46);
var sound_1 = __webpack_require__(12);
var spike_1 = __webpack_require__(19);
var textParticle_1 = __webpack_require__(18);
var dashParticle_1 = __webpack_require__(48);
var levelConstants_1 = __webpack_require__(2);
var pickup_1 = __webpack_require__(11);
var crate_1 = __webpack_require__(23);
var stats_1 = __webpack_require__(49);
var chest_1 = __webpack_require__(17);
var barrel_1 = __webpack_require__(22);
var camera_1 = __webpack_require__(13);
var door_1 = __webpack_require__(6);
    ...
    function Player(game, x, y) {
        ...
        this.tryDash = function (dx, dy) {
            ...
            while (x !== startX + 2 * dx || y !== startY + 2 * dy) {
                ...
                else if (other instanceof onCollideTile_1.OnCollideTile) {
                }
                else {
                    break;
                }
        ...
        this.tryMove = function (x, y) {
            ...
            else if (_this.game.level.getCollidable(x, y) instanceof onCollideTile_1.OnCollideTile) {
                _this.move(x, y);
...
var input_1 = __webpack_require__(25);
var gameConstants_1 = __webpack_require__(1);
var equippable_1 = __webpack_require__(47);
...
Object.defineProperty(exports, "__esModule", { value: true });
var statconstants_1 = __webpack_require__(50);
var game_1 = __webpack_require__(0);
var gameConstants_1 = __webpack_require__(1);
var levelConstants_1 = __webpack_require__(2);
var Stats = (function () {
